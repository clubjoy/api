  ...
  const additionalExperiences = await Promise.all([
    prisma.experience.create({
      data: {
        ...
        hostId: host2.id,
        images: [
          'https://images.unsplash.com/photo-1534307671554-9a6d81f4d629',
          'https://images.unsplash.com/photo-1583037189850-1921ae7c6c22',
        ],
        coverImage: 'https://images.unsplash.com/photo-1534307671554-9a6d81f4d629',
        category: 'Adventure',
    ...
    prisma.experience.create({
      data: {
        ...
        hostId: host1.id,
        images: [
          'https://images.unsplash.com/photo-1452827073306-6e6e661baf57',
          'https://images.unsplash.com/photo-1610701596007-11502861dcfa',
        ],
        coverImage: 'https://images.unsplash.com/photo-1452827073306-6e6e661baf57',
        category: 'Culture',
